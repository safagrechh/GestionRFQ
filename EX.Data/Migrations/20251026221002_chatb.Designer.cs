...
namespace EX.Data.Migrations
{
    ...
    [Migration("20251026221002_chatb")]
    partial class chatb
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EX.Core.Domain.ChatAttachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EX.Core.Domain.ChatConversation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EX.Core.Domain.ChatMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EX.Core.Domain.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EX.Core.Domain.ChatAttachment", b =>
                {
                    b.HasOne("EX.Core.Domain.ChatMessage", "Message")
            ...
            modelBuilder.Entity("EX.Core.Domain.ChatMessage", b =>
                {
                    b.HasOne("EX.Core.Domain.ChatConversation", "Conversation")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("EX.Core.Domain.RFQ", b =>
                {
                    ...
                    b.HasOne("EX.Core.Domain.User", "CreatedByUser")
                        .WithMany()
